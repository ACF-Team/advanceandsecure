...
do	-- Hookery
	do	-- Teamkill handling
		local function HandleKill(victim, _, attacker)
	...
	do	-- Other prevention
		...
		AAS.Funcs.AddHook(DefaultMode, "PlayerCanJoinTeam", function() return false end)
		...
		AAS.Funcs.AddHook(DefaultMode, "EntityTakeDamage", function(ent)
